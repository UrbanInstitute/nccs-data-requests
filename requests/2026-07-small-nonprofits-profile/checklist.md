# Request checklist — 2026-07-small-nonprofits-profile
...
- [x] **Public-safe:** uses only public IRS / published-derived data; the
      `.qmd` contains no confidential requester specifics. → **yes**
